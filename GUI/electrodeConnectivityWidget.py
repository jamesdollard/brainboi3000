...
class ElectrodeConnectivityWidget(QWidget):
    def __init__(self, parentSelf):
        ...
        title = QLabel("Let's make sure that the electrodes are connected!")
